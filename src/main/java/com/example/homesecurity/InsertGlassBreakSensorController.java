...
import threads.SaveGlassBreakSensorThread;
...
public class InsertGlassBreakSensorController {
    ...
    public void saveNewGlassBreakSensor(){
        ...
        try {
            saveNewGlassBreakSensorHelper(glassBreakSensorName, glassBreakSensorManufacturer, glassBreakSensorModel, glassBreakSensorSerialNumber, glassBreakSensorManufacturingDate);
        }
    ...
    private void saveNewGlassBreakSensorHelper(String glassBreakSensorName, String glassBreakSensorManufacturer,
                                               String glassBreakSensorModel, String glassBreakSensorSerialNumber, LocalDate glassBreakSensorManufacturingDate) throws EmptyFieldException {
        ...
        &&!glassBreakSensorModel.isEmpty() && !glassBreakSensorSerialNumber.isEmpty() && glassBreakSensorManufacturingDate !=null){
            ...
            GlassBreakSensor sensor = (GlassBreakSensor) GlassBreakSensor.builder()
                    ...
                    .build();
            sensor.setGlassBreak(false);

            FileUtil.serializeGlassBreakSensor(sensor);
            ...
            SaveGlassBreakSensorThread saveGlassBreakSensorThread=new SaveGlassBreakSensorThread(sensor, change);
